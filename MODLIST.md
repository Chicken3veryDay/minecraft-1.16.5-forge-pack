...
Generated: 2026-06-04T00:01:42.1271799Z

## Release

- Minecraft: 1.16.5
- Forge: 36.2.42
- Asset archive: `pack-assets-ea53010738f8.zip`
- Asset SHA-256: `ea53010738f8515437c2796109a810e54598c6d03f90103ca80ec74d71b059fd`
- Asset URL: <https://github.com/Chicken3veryDay/minecraft-1.16.5-forge-pack/releases/download/v2026.06.03/pack-assets-ea53010738f8.zip>
- Minimal installer: `minimal-pack-37b5550fc52a.zip`
- Minimal installer SHA-256: `37b5550fc52a3f4efeadefa772fb55fc9b1ef6e73e84523bab6889f8a30f4540`
...
- Validation: Dependency audit reads each jar META-INF/mods.toml and manifest Implementation-Version. Latest audit after the performance/config pass: Client has 138 jars, Server has 114 jars, Config has 2 files, with no missing required dependencies, no incompatible required dependency ranges, no duplicate mod IDs, no Polymorph jar present, no MyServerIsCompatible jar present in Client, and Mowzie's Mobs 1.5.27 present on both sides.
- Note: Performance pass: removed low-content/TPS-risk client-server mods The Hordes, Mobs Properties Randomness, What Are They Up To, Champions, Scaling Health, Smarter Farmers, Guard Villagers, Hats, Morph, Pandora's Box, Craziness Awakened, LightAura, Dragonfight, Gateways To Eternity, and Item Collectors; also removed their now-unused libraries Atlas Lib, InsaneLib, CoroUtil, iChunUtil, and SuperMartijn642 Core/Config Lib.
- Note: Remote apply helper: tools/remote_apply_perf_optimizations.sh backs up exactly those server jars, preserves the VPS-friendly view-distance=4 and entity-broadcast-range-percentage=50 settings, then sets sync-chunk-writes=false, network-compression-threshold=512, and max-tick-time=180000 before restarting Minecraft.
- Note: Abyss config fix: Config/theabyss2.json is included and was copied to the live server to stop the join-time FileNotFoundException from The Abyss 2.
...
| `theabyss2.json` | 279 | `e8e7d0af44287d8550b2f0eeccf5c732c72bde0986850b810aaa1da61ee3bbd8` |
