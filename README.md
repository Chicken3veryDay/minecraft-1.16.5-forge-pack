...
Crafting fix in the current pack: Polymorph was removed from client and server because it hooks recipe manager/workbench/result synchronization and matched the many-crafting-UI ghost-result symptom.